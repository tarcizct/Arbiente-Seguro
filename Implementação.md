...
O primeiro passo da implementação do projeto se deu por individualmente fazer funcionar cada um dos componentes necessários, sendo eles o Buzzer, MQ-135, Aplicativo Blinky e a ESP 32.

## Buzzer

O primeiro teste foi feito com o Buzzer. A conexão feita está abaixo, com um resistor de 1.5kΩ:
<p align="center">
